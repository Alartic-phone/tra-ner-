...
describe("contraste des couples texte/fond (WCAG AA)", () => {
  it.each([
    ...
    // faint porte aussi du texte courant (hints, labels) sur ces deux fonds,
    // pas seulement du décoratif large — exige donc le seuil normal ici.
    ["faint sur surface (texte courant — hints, labels)", COLORS.faint, COLORS.surface, AA_NORMAL],
    ["faint sur surface-2 (texte courant — hints, labels)", COLORS.faint, COLORS.surface2, AA_NORMAL],
